...
public:
  ...
  AngMatcher(Image* im1_, Image* im2_,
             FisheyeLens* lens_,
             cv::Mat F_,
  ...
  std::vector<std::vector<double>> MatchAngle3D(double th, bool bCrossVerification);
  ...
  std::vector<std::vector<double>> GetMatches(std::string method, int kp = -1);
  std::vector<std::vector<bool>> GetMatchesBool(std::string method, int kp = -1);

  std::vector<cv::DMatch> GetMatchesNN(std::string method);

  int GetMatchesNN(std::string method, int kp);

  std::vector<cv::DMatch> GetMatchesDesc(std::string method);

  int GetMatchesDesc(std::string method, int kp);
  ...
  //std::string ReportCandidates(int kp_id);
...
private: 
  ...
  std::vector<std::vector<std::vector<bool>>> candidates_bool_;
